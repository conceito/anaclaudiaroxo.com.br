...
$db['development']['database'] = 'anaclaudiaroxo';
...
$db['production']['hostname'] = 'dbmy0043.whservidor.com';
$db['production']['username'] = 'anaroxo';
$db['production']['password'] = 'anabase01';
$db['production']['database'] = 'anaroxo';

...
$route['procedimentos/pag:(:any)'] = "procedimentos/index/$1";// paginação
$route['procedimentos/(:any)'] = "procedimentos/display/$1";// paginação

$route['duvidas-frequentes/pag:(:any)'] = "faq/index/$1";// paginação
$route['duvidas-frequentes/categoria/(:any)'] = "faq/categoria/$1";// categoria
$route['duvidas-frequentes/(:any)'] = "faq/display/$1";
$route['duvidas-frequentes'] = "faq/index";

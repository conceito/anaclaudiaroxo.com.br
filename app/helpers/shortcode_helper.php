...
if (!function_exists('sc_page_featured_img'))
{

    function sc_page_featured_img($atts = array(), $content = '')
    {
        if (strlen(trim($content)) == 0)
        {
            return '';
        ...
        $imgThumb = thumb($gallery[0]['nome']);
        $imgBig = grande($gallery[0]['nome']);

        $html = '<div class="-page-featured-img">';

        $html .= '<img src="' . $p . $gallery[0]['nome'] . '" />';

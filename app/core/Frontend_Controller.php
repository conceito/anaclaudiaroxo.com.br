...
class Frontend_Controller extends MY_Controller {
    ...
    private $JSfixo = array('jquery-1.10.2.min', 'bootstrap.min', 'jquery-scrollto', 'page.all');     // assets précarregados
    private $CSSfixo = array('bootstrap', 'bootstrap-responsive', 'base-layout', 'module-template');// assets précarregados
...
//                $this->output->cache(60);
        ...
        $this->load->library(array('site_utils', 'cms_conteudo', 'cms_posts', 'cms_adminbar', 'breadcrumb', 'cms_loja'));
    ...
    public function templateRender($template = 'template/main') {
        ...
        $this->tmp['footer'] = $this->renderFooter();
        // sidebar
        $this->tmp['sidebar'] = '';
        // scripts adicionais
...
//        }
    ...
    {
        $v['menu'] = '';
        return $this->load->view('partial/header', $v, true);
    }
    ...
    {
        $v['menu'] = '';
        return $this->load->view('partial/footer', $v, true);
    }
    ...
    public function setNewPlugin($pluginName){
        ...
        foreach($pluginName as $plugin){
            ...
            if($plugin == 'swiper'){
                $this->setNewEstyle(array('idangerous.swiper'));
                $this->setNewScript(array('idangerous.swiper.min'));

...
class Calendario extends Cms_Controller {
     ...
     * ao preencher usar "/" após a string
     * @var string 
     */
    protected $view = "calendario";
...
//        $this->css = array();
        ...
        $this->tabs['tab_contt'][] = $this->load->view("cms/{$this->view}/novo", $this->dados, true);
        /*
         * TEMPLATE
         */
        $this->templateRender();
...
//        mybug($conteudo);
        ...
        $this->tabs['tab_contt'][] = $this->load->view("cms/{$this->view}/edita", $this->dados, true);
...
//        $this->dados['swfUplForm'] = $this->getSwfUplForm();
        ...
        $this->tabs['tab_contt'][] = $this->load->view("cms/{$this->view}/subs_options_novo", $this->dados, true);
        /*
         * TEMPLATE
         */
        $this->templateRender();
...
//        mybug($conteudo);
        ...
        $this->tabs['tab_contt'][] = $this->load->view("cms/{$this->view}/subs_options_editaopts", $this->dados, true);
        $this->tabs['tab_title'][] = 'Dados básicos';
        $this->tabs['tab_contt'][] = $this->load->view("cms/{$this->view}/subs_options_edita", $this->dados, true);

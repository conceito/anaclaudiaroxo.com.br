...
<div class="panel-left clearfix">
	...
	<textarea name="header_txt" class="textarea-curto" id="header_txt"><?php echo set_value('header_txt', $con['header_txt']);?>
    </textarea> 
	...
	<textarea name="footer_txt" class="textarea-curto" id="footer_txt"><?php echo set_value('footer_txt', $con['footer_txt']);?>
    </textarea> 
	<div class="help-block">Não usar caracteres especiais e espaço.</div>
